...
This guide provides step-by-step instructions for migrating SAP HANA XS Classic applications to SAP Hana Native using Visual Studio Code with the SAP HANA Application Migration extension.
...
4. **Migration Complete**
   - The extension will generate:
     - **Hana Native project structure** with migrated artifacts
     - **db/** folder with HANA artifacts
...
Follow [README.md - Step 6: Deployment](README.md#step-7-deployment-of-the-migrated-database-artifacts)
...
- [SAP Hana Application Migration Vscode](https://help.sap.com/docs/hana-cloud/sap-hana-cloud-migration-guide/migrate-xs-classic-application-to-sap-hana-native-with-sap-hana-application-migration-assistant-in-visual-studio-code)
