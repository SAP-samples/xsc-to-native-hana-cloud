...
sap.account.WelcomeDialog.prototype.open = function () {
    ...
    // vspace
    oContentMatrix.addRow(new sap.ui.commons.layout.MatrixLayoutRow({ height: '15px' }));
    // intro text
    ...
    // vspace
    oContentMatrix.addRow(new sap.ui.commons.layout.MatrixLayoutRow({ height: '5px' }));
    ...
    oCell = new sap.ui.commons.layout.MatrixLayoutCell({ hAlign: sap.ui.commons.layout.HAlign.Left });
    oTextView = new sap.ui.commons.TextView({
        text: sap.app.i18n.getText("WHATS_NEW_PREV"),
        design: sap.ui.commons.TextViewDesign.H3,
        width: '100%',
        textAlign: sap.ui.core.TextAlign.Center
    });
    ...
    oTextView = new sap.ui.core.HTML({
        content: sap.app.i18n.getText("SHINE_WHATS_NEW_PREV"),
        width: '100%'
    });
    oCell.addContent(oTextView);
    oRow.addCell(oCell);
    ...
    function createWelcomeHeaderRow() {
        ...
        var oHorizontalLayout = new sap.ui.commons.layout.HorizontalLayout({
            content: [
                new sap.ui.commons.Image({ src: "./launchpad/images/SAPLogo.gif" }),
                textView
            ]
        });
