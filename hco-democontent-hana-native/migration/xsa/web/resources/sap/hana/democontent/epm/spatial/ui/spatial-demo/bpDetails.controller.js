sap.ui.controller("spatial-demo.bpDetails", {
    ...
    onAfterRendering: function () {
        ...
        var addresses = [], labels = [], bps = [];
        // Obtain the default map types from the platform object:
        var defaultLayers = sap.app.platform.createDefaultLayers();
        // Instantiate (and display) a map object:
        var map = new H.Map(document.getElementById("__splitter0_firstPane"), defaultLayers.normal.map, {
            zoom: 2,
            center: {
                lat: 0.0,
                lng: 0.0
        ...
        function locationNotFound(err) {
            ...
            sap.ui.commons.MessageBox.alert(sap.app.i18n.getText("REVEAL_COORDINATES"), sap.ui.commons.MessageBox.Icon.INFORMATION, sap.app.i18n.getText("LOCREQUIRED"));
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var z = 0; z < bps.length; z++) {
                    ...
                    var cood = new H.clustering.DataPoint(parseFloat(bps[z].lat), parseFloat(bps[z].long), 1, bps[z]);
                ...
                jQuery.sap.require("sap.ui.commons.MessageBox");
                sap.ui.commons.MessageBox.alert(sap.app.i18n.getText("SELECT_BP"), sap.ui.commons.MessageBox.Icon.INFORMATION, sap.app.i18n.getText("TITLE"));
            },
            error: function (err) {
            }
        });
