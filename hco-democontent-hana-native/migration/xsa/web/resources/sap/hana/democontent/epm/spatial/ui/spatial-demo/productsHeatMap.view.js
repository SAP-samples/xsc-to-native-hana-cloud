...
sap.ui.jsview("spatial-demo.productsHeatMap", {
    ...
    createContent: function (oController) {
        ...
        view.oList.addItem(new sap.m.GroupHeaderListItem({ title: sap.app.i18n.getText("CHOOSE_PRODUCT") }));
        ...
        view.oList.addItem(new sap.m.CustomListItem({ content: [view.selector] }));
        // sales chart
        view.oList.addItem(new sap.m.GroupHeaderListItem({ title: sap.app.i18n.getText("PRODUCT_SALES_YOY") }));
