 ...
 */
var oBundle = initLocalization("i18n/messagebundle.hdbtextbundle");
...
function displayError(error) {
    ...
    if (jQuery.device.is.desktop) {
        ...
        sap.ui.commons.MessageBox.show(error.message, sap.ui.commons.MessageBox.Icon.ERROR, oBundle.getText("ERROR_MESSAGE_TITLE"), [sap.ui.commons.MessageBox.Action.OK]);
    } else {
        jQuery.sap.require("sap.m.MessageBox");
        sap.m.MessageBox.show(error.message, sap.m.MessageBox.Icon.ERROR, oBundle.getText("ERROR_MESSAGE_TITLE"), [sap.m.MessageBox.Action.CLOSE]);
    }
}
/**
