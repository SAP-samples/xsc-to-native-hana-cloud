jQuery.sap.declare("shine.usercrud.etagsdemo.app.tileDialog");
function HelpDialog() {
    this.oSimpleForm;
    this.addContent = function (oInfoSettings, oi18n) {
        ...
        for (i = 0; i < oNum; i++) {
            this.oSimpleForm.addContent(new sap.m.Label({
                design: "Bold",
                visible: true,
                text: oi18n.getProperty('INFOHELP_' + oInfoSettings.toUpperCase() + '_LABEL_' + i)
            }));
