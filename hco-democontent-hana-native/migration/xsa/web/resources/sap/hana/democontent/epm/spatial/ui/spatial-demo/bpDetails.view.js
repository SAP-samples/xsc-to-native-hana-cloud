sap.ui.jsview("spatial-demo.bpDetails", {
    ...
    createContent: function (oController) {
        ...
        var oList = new sap.m.List({ width: '100%' });
        oList.addItem(new sap.m.GroupHeaderListItem({ title: sap.app.i18n.getText("SALES_DATA") }));
        view.bpId = new sap.m.ObjectAttribute({});
        view.bpPhone = new sap.m.ObjectStatus({ state: sap.ui.core.ValueState.None });
        view.bpEmail = new sap.m.ObjectStatus({ state: sap.ui.core.ValueState.None });
        ...
        // sales chart
        oList.addItem(new sap.m.GroupHeaderListItem({ title: sap.app.i18n.getText("SALES_CHART_TITLE") }));
        ...
        oList.addItem(new sap.m.CustomListItem({ content: [view.oSalesChart] }));
        // address details
        oList.addItem(new sap.m.GroupHeaderListItem({ title: sap.app.i18n.getText("ADDRESS") }));
        // building
