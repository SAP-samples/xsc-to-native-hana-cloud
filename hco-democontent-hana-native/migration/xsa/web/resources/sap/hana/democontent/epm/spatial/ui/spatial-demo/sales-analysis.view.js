sap.ui.jsview("spatial-demo.sales-analysis", {
    ...
    createContent: function (oController) {
        ...
        view.oList = new sap.m.List({ width: '100%' });
        ...
        view.oList.addItem(new sap.m.GroupHeaderListItem({ title: sap.app.i18n.getText("SALES_REGION_DATA") }));
        ...
        // sales chart
        view.oList.addItem(new sap.m.GroupHeaderListItem({ title: sap.app.i18n.getText("SALES_CHART_TITLE") }));
        ...
        view.oList.addItem(new sap.m.CustomListItem({ content: [view.oSalesChart] }));
        // top customer details
        view.oList.addItem(new sap.m.GroupHeaderListItem({ title: sap.app.i18n.getText("TOP_5_BP") }));
