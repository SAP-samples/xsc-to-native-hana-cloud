...
sap.account.TileDialog.prototype.getHrefLocation = function (tileID) {
    switch (tileID) {
    case 1:
        return '/sap/hana/democontent/epm/admin/admin.html';
    case 2:
        return '/sap/hana/democontent/epm/ui/poworklist/poWorklist.html';
    case 3:
        return '/sap/hana/democontent/epm/ui/salesDashboard/index.html';
    case 4:
        return '/sap/hana/democontent/epm/ui/salesDashboard/soWorklist.html';
    case 5:
        return '/sap/hana/democontent/epm/ui/userCRUD/index.html';
    case 6:
        return '/sap/hana/uis/clients/ushell-app/shells/hana/shell.html#appsite-display~ctx?siteID=sap%7Chana%7Cdemocontent%7Cepm%7Cui%7Cuis%7Csite%7CUISExample';
    case 7:
        return '/sap/hana/uis/clients/desktop/applications/uis/runtime.html?siteID=sap%7Chana%7Cdemocontent%7Cepm%7Cui%7Cuis%7Csite%7CUISExample#context/eyJjdHhSb3V0ZUlkIjoiMTM4MzA1MTUzODI3MiIsImNvbnRleHRNYXAiOnt9fQ==';
    case 8:
        return '/sap/hana/democontent/epm/spatial/ui/index.html';
    case 9:
        return '/sap/hana/democontent/epm/fulltextsearch/ui/search.html';
    case 10:
        return '/sap/hana/democontent/epm/ui/salesDashMobile/index.html';
    case 11:
        return '/sap/hana/uis/clients/ushell-app/shells/fiori/FioriLaunchpad.html?siteId=sap.hana.democontent.epm%7Cui%7Cuis%7CFioriLaunchPad%7CFioriShineLaunchPad';
    case 12:
        return '/sap/hana/democontent/epm/xsds/ui/index.html';
    case 13:
        return '/sap/hana/testtools/unit/jasminexs/TestRunner.xsjs?package=sap.hana.democontent.epm.test';
    case 14:
        return '/sap/hana/democontent/epm/ui5search/ui/index.html';
    case 15:
        return '/sap/hana/democontent/epm/jobscheduling/ui/index.html';
    case 16:
        return '/sap/hana/democontent/epm/etagsxsodata/ui/index.html';
    }
};
sap.account.TileDialog.prototype.open = function (tileID) {
    ...
    // vspace
    oContentMatrix.addRow(new sap.ui.commons.layout.MatrixLayoutRow({ height: '30px' }));
    // description
    ...
    // vspace
    oContentMatrix.addRow(new sap.ui.commons.layout.MatrixLayoutRow({ height: '10px' }));
    oContentMatrix.addRow(createDividerRow());
    // business scenario
    if (showBusinessScenario(tileID)) {
        oRow = new sap.ui.commons.layout.MatrixLayoutRow();
        oCell = new sap.ui.commons.layout.MatrixLayoutCell({ hAlign: sap.ui.commons.layout.HAlign.Left });
    ...
    var ok = function (oEvent) {
        ...
        oTileDialog.close();
        setTimeout(function () {
            window.location = dialog.getHrefLocation(tileID);
        }, 1000);
    };
    ...
    function getPermissions(tileID) {
        ...
        case 13:
            ...
            var duImport = false, executeRole = false;
            $.ajax({
                url: "/sap/hana/democontent/epm/ui/launchpad/services/xsUnitPermission.xsjs?cmd=DU",
                success: function (response) {
                    if (response === "Hana Test Tools imported") {
                        responseBody += "<li>" + sap.app.i18n.getText("TILE_PERMS_XSUNT_DU") + " - <img src='/sap/hana/democontent/epm/ui/launchpad/images/green_tick.png' /> </li>";
                        duImport = true;
                    } else {
                        responseBody += "<li>" + sap.app.i18n.getText("TILE_PERMS_XSUNT_DU") + " - <img src='/sap/hana/democontent/epm/ui/launchpad/images/red_cross.png' /></li>";
                    }
                },
                error: function () {
                    responseBody += "<li>" + sap.app.i18n.getText("TILE_PERMS_XSUNT_DU") + " -<span style='color:red'> Error while checking permission</span> </li>";
                },
                async: false
            });
            $.ajax({
                ...
                success: function (response) {
                    if (response === "Test Execute Role available") {
                        responseBody += "<li>" + sap.app.i18n.getText("TILE_PERMS_XSUNT_ROLE") + " - <img src='/sap/hana/democontent/epm/ui/launchpad/images/green_tick.png' /> </li>";
                        executeRole = true;
                    } else {
                        responseBody += "<li>" + sap.app.i18n.getText("TILE_PERMS_XSUNT_ROLE") + " - <img src='/sap/hana/democontent/epm/ui/launchpad/images/red_cross.png' /> </li>";
                    }
                },
                error: function () {
                    responseBody += "<li>" + sap.app.i18n.getText("TILE_PERMS_XSUNT_ROLE") + " - <span style='color:red'> Error while checking permission </span><</li>";
                },
                async: false
            });
