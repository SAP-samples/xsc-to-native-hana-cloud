sap.ui.controller("shine.democontent.epm.usercrud.view.usercrud", {
    onInit: function () {
        ...
        var data = { languages: [{ "name": "German" }] };
    ...
    callUserService: function () {
        ...
        oModel.create('/Users', oEntry, null, jQuery.proxy(function () {
    ...
    onAddCC: function (oEvent) {
        ...
        if (!userId) {
            ...
            var input = new sap.ui.commons.TextField({ width: '100%' });
    ...
    uploadXml: function () {
        ...
        if (this.oFileUploader.oFileUpload.files.length) {
            var jqxhr = jQuery.ajax({
                ...
                that.oFileUploader.addHeaderParameter(new sap.ui.commons.FileUploaderParameter({
                    name: "x-csrf-token",
                    value: token
                }));
