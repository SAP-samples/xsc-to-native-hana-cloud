...
sap.ui.controller("shine.usercrud.etagsdemo.view.App", {
    handlePressHome: function (oEvent) {
        sap.m.URLHelper.redirect("/sap/hana/democontent/epm/ui/NewLaunchpad.html", false);
    },
    ...
    createUser: function (oEvent) {
        ...
        oEntry.E_MAIL = sap.ui.getCore().byId('idDgEMail').getValue();
        if (oEntry.LASTNAME === "") {
        ...
        $.ajax({
            type: "GET",
            async: false,
            url: "/sap/hana/democontent/epm/etagsxsodata/services/eTagsServices.xsjs",
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                oModel.create("/UserDetails", oEntry, null, function (success) {
                    sap.m.MessageBox.show(i18n.getProperty("CREATE_USER_SUCCESS"), {
                        icon: sap.m.MessageBox.Icon.SUCCESS,
                        title: i18n.getProperty("CREATE_USER"),
                        actions: [sap.m.MessageBox.Action.OK]
                    });
                }, function (err) {
                    sap.m.MessageBox.show(i18n.getProperty("CREATE_USER_FAILURE"), {
    ...
    updateUser: function (oEvent) {
        ...
        oModel.update(oContext, oEntry, null, function (success) {
            sap.m.MessageBox.show(i18n.getProperty("USER_UPDATE_SUCCESS"), {
                icon: sap.m.MessageBox.Icon.SUCCESS,
            ...
            if (i18n.getProperty("ETAGS_PRECOND_FAILED") === err.response.statusText) {
                sap.m.MessageBox.show(i18n.getProperty("USER_UPDATE_FAILED"), {
                    icon: sap.m.MessageBox.Icon.ERROR,
                    title: i18n.getProperty("UPDATE_USER_DETAILS"),
                    actions: [sap.m.MessageBox.Action.OK]
                });
    ...
    deleteUser: function (oEvent) {
        ...
        if (!UTIL.validateTableRowSelected(this, 'idUserCRUDTable')) {
            sap.m.MessageBox.show(i18n.getProperty("ROW_SELECTION"), {
                icon: sap.m.MessageBox.Icon.ERROR,
        ...
        oModel.remove(oContext, null, function (success) {
            sap.m.MessageBox.show(i18n.getProperty("DELETE_USER_SUCCESS"), {
                icon: sap.m.MessageBox.Icon.SUCCESS,
                title: i18n.getProperty("DELETE_USER"),
                actions: [sap.m.MessageBox.Action.OK]
            });
            ...
            if (i18n.getProperty("ETAGS_PRECOND_FAILED") === err.response.statusText) {
                sap.m.MessageBox.show(i18n.getProperty("DELETE_USER_FAILED"), {
                    icon: sap.m.MessageBox.Icon.ERROR,
                    title: i18n.getProperty("DELETE_USER"),
                    actions: [sap.m.MessageBox.Action.OK]
                });
    ...
    onCloseDialog: function (oEvent) {
        ...
        if (srcBtnText === "Ok") {
            ...
            if (UTIL.validateFirstName(sap.ui.getCore().byId('idDgFirstName').getValue()) && UTIL.validateLastName(sap.ui.getCore().byId('idDgLastName').getValue()) && UTIL.validateEMail(sap.ui.getCore().byId('idDgEMail').getValue())) {
                ...
                sap.m.MessageBox.show(i18n.getProperty("USER_INPUT_INVALID"), {
                    icon: sap.m.MessageBox.Icon.ERROR,
    ...
    filterNullValue: function (oEvent) {
        ...
        var oSorter = new sap.ui.model.Sorter("PERS_NO", true);
        if (oEvent.getSource().getPressed()) {
            ...
            var oFilter3 = new sap.ui.model.Filter("E_MAIL", sap.ui.model.FilterOperator.EQ, null);
            arr.push(oFilter1);
            arr.push(oFilter2);
            arr.push(oFilter3);
    ...
    clearUserDetailsLogs: function (oEvent) {
        ...
        $.ajax({
            ...
            contentType: "application/json",
            success: function (data) {
                sap.m.MessageBox.show(i18n.getProperty("USER_DETAILS_LOGS_DELETION_SUCCESS"), {
                    icon: sap.m.MessageBox.Icon.SUCCESS,
            ...
            error: function (xhr, ajaxOptions, thrownError) {
                sap.m.MessageBox.show(i18n.getProperty("USER_DETAILS_LOGS_DELETION_FAILURE"), {
                    icon: sap.m.MessageBox.Icon.ERROR,
                    title: i18n.getProperty("USER_DETAILS_LOGS_DELETION"),
                    actions: [sap.m.MessageBox.Action.OK]
                });
