sap.ui.controller("sap.hana.democontent.epm.salesdashboard.view.details", {
    ...
    onDeletePress: function (oEvent) {
        ...
        if (soId && soId !== undefined) {
            sap.ui.commons.MessageBox.confirm(sap.app.i18n.getText("CONFIRM_DELETE", [soId]), function (bResult) {
    ...
    onDeleteSuccess: function (myTxt, oController) {
        ...
        sap.ui.commons.MessageBox.show(sap.app.i18n.getText("DELETE_SUCCESS"), "SUCCESS", sap.app.i18n.getText("TITLE_DELETE_SUCCESS"));
    },
    ...
    onSubmit: function (min, max) {
        ...
        if (view.oComboBoxBp._getExistingListBox().getSelectedItem() === null) {
            sap.ui.commons.MessageBox.show(sap.app.i18n.getText("FILL_ALL_LINE_ITEMS"), "ERROR", sap.app.i18n.getText("TITLE_MISSING_DATA"));
            return;
        }
        var endindex = max;
        ...
        for (var beginindex = min + 1; beginindex < endindex; beginindex++) {
            if (jQuery.sap.domById('productsel' + beginindex + '-input') !== null) {
                ...
                if (Number(Quantity) <= 0 || isNaN(Number(Quantity)) || Number(Quantity) % 1 !== 0) {
                    sap.ui.commons.MessageBox.show(sap.app.i18n.getText("TITLE_VALID_INTEGER"), "ERROR", sap.app.i18n.getText("CHECK_VALID_INTEGER"));
                    return;
                }
            }
        }
        ...
        $.ajax({
            ...
            dataFilter: function (data) {
                ...
                sap.ui.commons.MessageBox.show('Sales Order ' + oSalesOrderId + ' Created Successfully', "SUCCESS", sap.app.i18n.getText("SALES_ORDER_CREATED"));
            }
        });
    ...
    onSendSuccess: function (response) {
        ...
        function cell(oContent) {
            return new sap.ui.commons.layout.MatrixLayoutCell({ content: oContent }, true);
        }
        ...
        var oLabel = new sap.ui.commons.Label({
            text: sap.app.i18n.getText("Email"),
            labelFor: oText
        }, true);
            ...
            press: function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        sap.ui.commons.MessageBox.show(sap.app.i18n.getText("EMAIL_SUCCESS_DESCRIPTION"), "SUCCESS", sap.app.i18n.getText("EMAIL_SUCCESS"));
                    },
                    error: function (response) {
                        sap.ui.commons.MessageBox.show(response.responseText, "Error", sap.app.i18n.getText("EMAIL_ERROR"));
                    }
                });
            }
        }, true);
        var oContent = new sap.ui.commons.layout.MatrixLayout({ layoutFixed: false }, true).addStyleClass("sapUiMboxCont");
    ...
    openTileDialog: function (oEvent) {
        ...
        var tileDialog = new sap.account.TileDialog(this, true);
    ...
    createNewDialogContent: function (oController) {
        ...
        view.oLayout = new sap.ui.commons.layout.MatrixLayout({ layoutFixed: false }, true);
        ...
        view.oComboBoxBp.setModel(new sap.ui.model.odata.ODataModel("/sap/hana/democontent/epm/services/businessPartners.xsodata", true));
        ...
        var sortBp = new sap.ui.model.Sorter("COMPANYNAME", true);
        ...
        var selectBpLbl = new sap.ui.commons.TextView({ text: sap.app.i18n.getText("SELECT_BP") }, true);
    ...
    createNewLineItemContent: function (oController) {
        ...
        var selectProductLblPd = new sap.ui.commons.TextView({ text: sap.app.i18n.getText("SELECT_PRODUCT") });
        // create a simple Input field
        var quantityInputPd = new sap.ui.commons.TextField({
            id: "quantitysel" + lineitemindex,
            value: "1"
        });
        var quantityLbPd = new sap.ui.commons.TextView({ text: sap.app.i18n.getText("ENTER_QUANTITY") });
