sap.ui.jsfragment("sap.hana.democontent.epm.salesdashboard.view.sendFailedDialog", {
    cell: function (oContent) {
        return new sap.ui.commons.layout.MatrixLayoutCell({ content: oContent });
    },
    image: function () {
        var oImage = new sap.ui.commons.Image({ decorative: true });
