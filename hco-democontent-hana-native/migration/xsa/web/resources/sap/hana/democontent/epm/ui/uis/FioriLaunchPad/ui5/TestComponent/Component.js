...
jQuery.sap.declare("test.TestComponent.Component");
// change this to your package/component name
// new Component
sap.ui.core.UIComponent.extend("test.TestComponent.Component", {
    //this should be changed to match the declare statement
    metadata: {
        //		"abstract": true,
        //		version : "1.0",
        ...
        //		},
        properties: {}    //		autoDestroy: false, // destroy component when view should be destroyed
