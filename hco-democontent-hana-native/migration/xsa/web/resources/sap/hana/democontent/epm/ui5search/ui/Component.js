    ...
    metadata: {
        ...
        properties: {
            ...
            title: {
                name: "title",
                type: "string",
                defaultValue: "Products Search in SHINE"
            },
            description: {
                name: "description",
                type: "string",
                defaultValue: "SHINE service for OData search"
            },
            url: {
                name: "url",
                type: "string",
                defaultValue: "/sap/hana/democontent/epm/ui5search/services/productTexts.xsodata"
            },
            schema: {
                name: "schema",
                type: "string",
                defaultValue: "sap.hana.democontent.epm"
            },
            entitySet: {
                name: "entitySet",
                type: "string",
                defaultValue: "PRODUCTS_TEXT"
            }
        }
    },
    init: function () {
