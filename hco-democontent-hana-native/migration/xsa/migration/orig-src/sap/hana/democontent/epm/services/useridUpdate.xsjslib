...
function my_create_after_exit(param) {
    ...
    try {
        ...
        pStmt = param.connection
            .prepareStatement('select "SAP_HANA_DEMO"."sap.hana.democontent.epm.data::userSeqId".NEXTVAL from dummy');
        ...
        pStmt = param.connection
            .prepareStatement('insert into SAP_HANA_DEMO."sap.hana.democontent.epm.data::User.Details" values(?,?,?,?)');
        pStmt.setString(1, persNo);
