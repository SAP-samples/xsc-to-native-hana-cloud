sap.ui.controller("shine.democontent.epm.xsjsMultiply.view.xsjsMultiply", {
    ...
    onLiveChange: function(oEvent) {
        var aUrl = '/sap/hana/democontent/epm/services/multiply.xsjs?cmd=multiply' + '&num1=' + escape(oEvent.getParameter("liveValue")) 
                    + '&num2=' + escape(oEvent.getSource() === this.oInput1 ? this.oInput2.getValue() : this.oInput1.getValue());
        jQuery.ajax({
            url: aUrl,
            method: 'GET',
            dataType: 'json',
