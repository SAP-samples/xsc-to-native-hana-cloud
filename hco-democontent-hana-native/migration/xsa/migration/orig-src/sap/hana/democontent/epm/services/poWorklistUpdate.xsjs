...
function deletePO() {
    ...
    try {
        ...
        query = 'SELECT LIFECYCLESTATUS, APPROVALSTATUS, CONFIRMSTATUS, ORDERINGSTATUS, INVOICINGSTATUS ' + 'from "SAP_HANA_DEMO"."sap.hana.democontent.epm.data::PO.Header" where PURCHASEORDERID = ?';
